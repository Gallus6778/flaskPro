...
class Replace_msisdn_in_xml_class:
    ...
    def __init__(self, msisdn):
        self.msisdn = msisdn
        self.filename = 'Complaints_internet/Request_by_MSISDN.xml' #HLR_xml_file/
...
# ------------ Method which modify msisdn in xml request_by_msisdn file and save it into 'output.xml' file -----------
    def main(self):
        ...
        tree.write('Complaints_internet/output.xml') #HLR_xml_file
        return 'Complaints_internet/output.xml' #HLR_xml_file
